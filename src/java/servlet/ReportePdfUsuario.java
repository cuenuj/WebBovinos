            ...
            try {
                if (request.getParameter("btn_genera_pdf")!= null) {
                 ...
                 String parrafo ="a continuación encontrará la infomación de los animales existentes, "
                         + "seguido de las enfermedades que se han presentado en esta finca "+"\n"+"\n"
                         +"Contenido:"+"\n" 
                         + "1.  Lista de animales existentes en la Finca "+"\n"
                         + "2.  Enfermedades Padecidas en la Finca "+"\n"+"\n";
                 ...
                 Paragraph p10= new Paragraph(parrafo,fuente1);
                    ...
                    for(Finca f :datos){
                        String idFinca="Nombre dueño de la Finca:  "+f.getExtencion_finca()+"  "+f.getId_dueno();
