    ...
    <body>
        ...
        <div>
                <pre class="bg-info text-left h4 ">
                    NOTA: 
                    Recuerde que para registrar un nuevo Usuario es necesaria 
                    la autorización del administrador del sistema</pre>

        </div>
        <div  class="container ">
            <pre class="bg-warning text-left h4 ">
                    Complete el siguiente formulario con sus datos y oprima el botón "Registrar Usuario", 
                ...
                <form action="registrar" class="form-signin ">
                    ...
                    <input type="password" id="PasswordAdmon" class="form-control" placeholder="contraseña administrador" required name="contrasena_funci">
                    <div class="checkbox">
                        
                    </div>
                    <h3 class="form-signin-heading">Datos del Usuario </h3>
                    <input type="text" id="cedula" class="form-control" placeholder="Cédula" required autofocus name="cedula_usuario">
                    ...
                    <input type="tel" id="telefono" class="form-control" placeholder="Teléfono" required autofocus name="telefono"><br/>
